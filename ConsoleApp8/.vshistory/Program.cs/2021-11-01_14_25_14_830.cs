...
namespace ConsoleApp8
{
    ...
    class Program
    {
        ...
        unsafe static void Main(string[] args)
        {
            ...
            SharedMemory.SetValue<MonitorWork>(Marshal.OffsetOf(typeof(MonitorWork), nameof(MonitorWork.Current)).ToInt32(), 1.ToByteArray());
            int we=  Marshal.OffsetOf(typeof(MonitorWork), nameof(MonitorWork.Index)).ToInt32();

            we += Marshal.SizeOf(typeof(short));
            SharedMemory.SetValue<MonitorWork>(we, 2.ToByteArray());
