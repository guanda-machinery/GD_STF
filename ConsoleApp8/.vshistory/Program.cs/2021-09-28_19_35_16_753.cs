            ...
            Drill[] L = new Drill[]
{
            ...
            work.Profile = "RH350X175X7X11".GetBytes(typeof(WorkMaterial).ArrayLength(nameof(WorkMaterial.Profile)));
            ...
            work.Profile = "RH600X200X11X17".GetBytes(typeof(WorkMaterial).ArrayLength(nameof(WorkMaterial.Profile)));
            work.PartNumber = "構件2".GetUInt16(typeof(WorkMaterial).ArrayLength(nameof(WorkMaterial.PartNumber)));
            work.Length = 10000D;
            Client.SetWorkMaterial(new WorkMaterial[] { work }, Marshal.SizeOf(typeof(WorkMaterial)) * 1);

            work.Profile = "RH588X300X12X20".GetBytes(typeof(WorkMaterial).ArrayLength(nameof(WorkMaterial.Profile)));
            work.PartNumber = "構件3".GetUInt16(typeof(WorkMaterial).ArrayLength(nameof(WorkMaterial.PartNumber)));
            work.Length = 6000D;
            Client.SetWorkMaterial(new WorkMaterial[] { work }, Marshal.SizeOf(typeof(WorkMaterial)) * 2);

            work.Profile = "RH588X300X12X20".GetBytes(typeof(WorkMaterial).ArrayLength(nameof(WorkMaterial.Profile)));
            work.PartNumber = "構件4".GetUInt16(typeof(WorkMaterial).ArrayLength(nameof(WorkMaterial.PartNumber)));
            work.Length = 6000D;
            Client.SetWorkMaterial(new WorkMaterial[] { work }, Marshal.SizeOf(typeof(WorkMaterial)) * 3);
