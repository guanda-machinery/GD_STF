...
namespace ConsoleApp8
{
    ...
    class Program
    {
        ...
        unsafe static void Main(string[] args)
        {
            ...
            work.BoltsCountM = 10;
            work.BoltsCountR = 2;
            Memor.ReadMemorClient readMemorClient = new ReadMemorClient();
            int cc = 0;
            while (true)
            {
                Thread.Sleep(1);
                readMemorClient.GetPanel();
                cc++;
                Console.WriteLine($"我是 iis 執行{cc}次");
            }
            Drill[] belly = new Drill[]
            {
                new Drill
                {
                    ...
                    X  = 53+120 +60 + 10 +040 + 35+35+35+35+35+35+35+35+35+35+35+35,
                    Y =80 ,
                },
                new Drill
                {
                              ...
                              new Drill
                {
                    Dia = 25,
                    AXIS_MODE = GD_STD.Enum.AXIS_MODE.PIERCE,
                    X  = 1513+120 +60 + 10 +040 + 35+35+35+35+35+35+35+35+35+35+35+35,
                    Y =80 ,
                },
                new Drill
                {
            ...
            Drill[] L = new Drill[]
{
                new Drill
                {
                    Dia = 19,
                    AXIS_MODE = GD_STD.Enum.AXIS_MODE.PIERCE,
                    X  = 63+120 +60 + 10 +040 + 35+35+35+35+35+35+35+35+35+35+35+35,
                    Y =50 ,
                },
                new Drill
                {
                                ...
                                new Drill
                {
                    Dia = 23,
                    AXIS_MODE = GD_STD.Enum.AXIS_MODE.PIERCE,
                    X  = 963+120 +60 + 10 +040 + 35+35+35+35+35+35+35+35+35+35+35+35,
                    Y =50 ,
                },
                new Drill
                {
            ...
            Drill[] R = new Drill[]
{
                new Drill
                {
                    Dia = 27,
                    AXIS_MODE = GD_STD.Enum.AXIS_MODE.PIERCE,
                    X  = 913+120 +60 + 10 +040 + 35+35+35+35+35+35+35+35+35+35+35+35,
                    Y =50 ,
                },
                       new Drill
                {
