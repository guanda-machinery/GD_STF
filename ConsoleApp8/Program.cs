...
namespace ConsoleApp8
{
    ...
    class Program
    {
        ...
        unsafe static void Main(string[] args)
        {
            ...
            //write.SetMecOptional(new MecOptional() { })
            write.SetAPPStruct(new APP_Struct() { Count = 3 , Traverse_Shelf_UP = GD_STD.Enum.SHELF.LEVEL2});
            ...
            //第0支
            {
                ...
                write.SetMonitorWorkOffset((0).ToByteArray(), SharedMemory.GetMemoryOffset(typeof(MonitorWork), nameof(MonitorWork.ExportOccupy1)));
