...
#define ResourceTypeVoltage             1   // 筿溃
#define ResourceTypeCPU                 2   // CPU 放
#define ResourceTypeBoard               3   // 诀狾放
#define ResourceTypeTemperature         4   // 放
#define ResourceTypeFanSpeed            5   // 硉
...
typedef struct _COPIED_WTS_SESSION_INFO {
	DWORD SessionId;
	LPSTR pWinStationName;		/* A ㄧ计┮иΤ才才﹃ */
	DWORD dummy;					/* 程琌猅羭 */
