...
#pragma warning disable CS1574 // XML 註解有無法解析的 cref 屬性 'Volume'
    /// <summary>
    /// 等待加工料件
    /// </summary>
    /// <revisionHistory>
    ///     <revision date="2021-07-23" version="1.0.0.4" author="LogicYeh">
    ///         <list type="bullet">
    ///             <item>改變資料型態<see cref="Material"/></item>
    ///         </list>
    ///     </revision>
    /// </revisionHistory>
    /// <revisionHistory>
    ///     <revision date="2021-09-24" version="1.0.0.5" author="LogicYeh">
    ///         <list type="bullet">
    ...
    /// </revisionHistory>
    [Serializable]
#pragma warning restore CS1574 // XML 註解有無法解析的 cref 屬性 'Volume'
    [DataContract]
    public struct WorkMaterial
    {
        ...
        /// <param name="stampData">鋼印資料</param>
        ...
        public WorkMaterial(string materialNumber = null, 
            string profile = null, 
            ...
            string id = null, 
            string source = null, 
            string smeltingNumber = null,
            float h = 0, 
            float w = 0,
            float t1 = 0, 
            float t2 = 0, 
            ushort boltsCountL = 0, 
            ushort boltsCountM = 0, 
            ushort boltsCountR = 0,
            ushort indexBoltsL = 0, 
            ushort indexBoltsM = 0, 
            ushort indexBoltsR = 0, 
            ...
            bool stamp = false, Stamp[] stampData = null, Drill[] drMiddle = null, Drill[] drRight = null, Drill[] drLeft = null, string gUID = null)
        {
            ...
            if (smeltingNumber != null)
                if (smeltingNumber.Length == result.SmeltingNumber.Length)
                    result.SmeltingNumber = Encoding.ASCII.GetBytes(smeltingNumber);
                else
