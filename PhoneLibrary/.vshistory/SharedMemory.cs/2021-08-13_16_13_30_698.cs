...
namespace GD_STD.Phone
{
    ...
    ///     </item>
    ///     <item>
    ///         SharedMemory&lt;T&gt;.SetValue(T)
    ///     </item>
    ///     <item>
    ///         SharedMemory&lt;T&gt;.GetValue()
    ///     </item>
    ///     <item>
    ///         新增
    ///     </item>
    ...
    ///     </item>
    ///     <item>
    ///         <see cref="SetValue{T}(T)"/>
    ///     </item>
    ///     <item>
    ///         <see cref="GetValue{T, TResult}(long, int)"/>
    ///     </item>
    ///     <item>
    ///         <see cref="SetValue{T}(long, byte[])"/>
    ///     </item>
    ///     <item>
    ///     </item>
    /// </list>
    ...
    public static class SharedMemory
    {
        ...
        /// 讀取記憶體
        /// </summary>
        /// <typeparam name="T">繼承 <see cref="ISharedMemoryOffset"/> 類型
        ///     </typeparam>
        /// <typeparam name="TResult">從 Unmanaged 記憶體區塊封送處理資料到新配置的指定類型的 Managed
        ///     物件</typeparam>
        ...
        /// <summary>
        /// 讀取 <typeparamref name="T"/> 記憶體內值定的位置，並使用 unsafe 轉換
        /// <see cref="char"/>[]
        /// </summary>
        /// <typeparam name="T"></typeparam>
