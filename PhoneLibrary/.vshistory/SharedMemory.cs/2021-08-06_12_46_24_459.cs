...
namespace GD_STD.Phone
{
    ...
    public static class SharedMemory
    {
        ...
        public static long GetMemoryOffset<T>(T obj, string fieldName) where T : IPhoneSharedMemoryOffset
        {
            ...
            string[] split;
            string nextField;
            NewMethod(obj, fieldName, out fieldInfos, out split, out nextField);
        ...
        private static void NewMethod<T>(T obj, string fieldName, out FieldInfo[] fieldInfos, out string[] split, out string nextField) where T : IPhoneSharedMemoryOffset
        {
