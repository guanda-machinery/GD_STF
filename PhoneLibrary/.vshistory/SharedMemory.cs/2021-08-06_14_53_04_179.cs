...
namespace GD_STD.Phone
{
    ...
    public static class SharedMemory
    {
        ...
        public static long GetMemoryOffset<T>(T obj, string fieldName)
        {
            ...
            string[] split;
            string nextField, cuurentFieldName;

            GetFieldString(fieldName, out split, out nextField, out cuurentFieldName);
            ...
            foreach (var field in fieldInfos)
            {
                if (field.FieldType.IsArray)
                {
                    ...
                    {
                        if (field.Name == fieldName.Substring(0, fieldName.IndexOf('[')))
                        {
                            if (nextField != "")
                            {
        ...
        private static void GetFieldString(string fieldName, out string[] split, out string nextField, out string cuurentFieldName)
        {
            ...
            cuurentFieldName = fieldName.Substring(0, fieldName.IndexOf('['));
        }
