...
namespace GD_STD.Base
{
    ...
    ///             <item><see cref="SetValue{T, TVaule}(long, TVaule, long, int)"/></item>
    ///         </list>
    ///     </revision>
    /// </revisionHistory>
    public static class SharedMemory
    {
        ...
        public static T SetValue<T, TVaule>(long position, TVaule value, int valueOffset, int count) where T : IPhoneSharedMemoryOffset, ISharedMemory, new() where TVaule : struct, ISharedMemoryOffset
        {
            T result = new T();
