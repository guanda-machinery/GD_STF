...
namespace GD_STD.Phone
{
    ...
    [Serializable]
    [DataContract]
    public struct MonitorWork : ISharedMemory, Base.ISharedMemory, ISharedMemoryOffset
    {
        /// <summary>
        /// 初始化結構
        /// </summary>
        ...
        public MonitorWork(char[] projectName = null, ushort schedule = 0, short[] index = null, WorkMaterial[] workMaterial = null, WorkMaterial[] matchWorkMaterial = null)
        {
        ...
        {
            throw new MemoryException($"寫入失敗。因整個結構寫入記憶體會造成衝突，請改用 SharedMemory.SetValue<T, TVaule>(position, value)");
        }
