...
#if LogicYeh
        , IPCSharedMemory, IPCSharedMemoryOffset, IPCMemoryPointer
#endif
    {
        /// <summary>
        /// 初始化結構
        ...
        MemoryMappedViewAccessor IPCMemoryPointer.ReadView()
        {
        ...
        /// <returns></returns>
        public static char[] ReadChar(int offset, int readLength, Type elementType)
        {
            ...
            using (MemoryMappedViewAccessor view = MonitorWorkMemory.CreateViewAccessor(0, size, MemoryMappedFileAccess.Read))
            {
                ...
                //Type elementType = typeof(MonitorWork).GetField(nameof(MonitorWork.ProjectName)).FieldType.GetElementType(); //陣列節點 type
