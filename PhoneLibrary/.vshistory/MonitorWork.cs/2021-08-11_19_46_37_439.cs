...
namespace GD_STD.Phone
{
...
#endif
    {
        ...
        void IPhoneSharedMemoryOffset.WriteMemory(long position, byte[] value)
        {
            ...
            Type indexType = Initialization().GetType().GetElementType(); // Index 陣列 TYPE
            ...
            long indexOffsetStart = indexStart + Marshal.SizeOf(this.Index.GetType().GetElementType()) * current;
