...
namespace GD_STD.Phone
{
    ...
    ///             <item><see cref="EntranceEquipment"/></item>
    ///             <item><see cref="ExportEquipment"/></item>
    ///         </list>
    ///     </revision>
    /// </revisionHistory>
    /// <example>
    ...
    public struct APP_Struct : ISharedMemory, Base.ISharedMemory
    {
        ...
        /// </summary>
        /// <remarks>
        /// 有選配回傳 true，沒有則回傳 false。
        /// </remarks>
        [DataMember]
        [MarshalAs(UnmanagedType.I1)]
        [PhoneCondition()]
        public bool EntranceEquipment;
        /// <summary>
        /// 出口設備選配
        /// </summary>
        /// <remarks>
        ...
        [DataMember]
        [MarshalAs(UnmanagedType.I1)]
        [PhoneCondition(nameof(SelectMove), SELECT_DEVICE.EXPORT)]
        [PhoneCondition(nameof(SelectMove), SELECT_DEVICE.ENTRANCE)]
