...
namespace GD_STD.Phone
{
    ...
    public struct WorkMaterial
    {
        ...
        public static WorkMaterial Initialization()
        {
            ...
            result.AssemblyNumber = new char[result.Length(nameof(AssemblyNumber))];
        ...
        private WorkMaterial(char[] materialNumber = null, char[] profile = null, char[] partNumber = null, double length = 0, ushort finish = 0, MATERIAL material = default, char[] assemblyNumber = null, char[] id = null, char[] source = null, char[] smeltingNumber = null, float h = 0, float w = 0, float t1 = 0, float t2 = 0, short boltsCountL = 0, short boltsCountM = 0, short boltsCountR = 0, short indexBoltsL = 0, short indexBoltsM = 0, short indexBoltsR = 0, PROFILE_TYPE profileType = default, bool stamp = false, Stamp[] stampData = null, Drill[] drMiddle = null, Drill[] drRight = null, Drill[] drLeft = null, byte[] gUID = null)
        {
        ...
        public WorkMaterial(ISteelBase steelBase, char[] materialNumber)
        {
            this = new WorkMaterial(materialNumber, steelBase.Profile.PadRight(30, '\0').ToArray(), 
                steelBase.PartNumber.PadRight(310, '\0').ToArray(), steelBase.Length,Finish = 0,steelBase.Material, steelBase.AsseNumber,);
        }
        /// <summary>
        /// 素材完成進度
        /// </summary>
