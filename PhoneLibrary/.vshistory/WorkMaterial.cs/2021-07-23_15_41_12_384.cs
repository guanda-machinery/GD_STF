...
namespace GD_STD.Phone
{
    ...
    public struct WorkMaterial
    {
        ...
        public WorkMaterial(char[] materialNumber = null, char[] profile = null, char[] partNumber = null, double length = 0, ushort finish = 0, char[] material = null, char[] assemblyNumber = null, char[] id = null, char[] source = null, char[] smeltingNumber = null, float h = 0, float w = 0, float t1 = 0, float t2 = 0, short boltsCountL = 0, short boltsCountM = 0, short boltsCountR = 0, short indexBoltsL = 0, short indexBoltsM = 0, short indexBoltsR = 0, PROFILE_TYPE profileType = default, bool stamp = false, Stamp[] stampData = null, Drill[] drMiddle = null, Drill[] drRight = null, Drill[] drLeft = null, byte[] gUID = null)
        {
            ...
            if (assemblyNumber != null)
                if (assemblyNumber.Length == result.Assembly.Length)
                    result.Assembly = assemblyNumber;
                else
