...
namespace GD_STD.Phone
{
    ...
    ///         <list type="bullet">
    ///             <item>新增 <see cref="AutoGauge"/></item>
    ///         </list>
    ///     </revision>
    /// </revisionHistory>
    /// <revisionHistory>
    ///     <revision date="2021-11-12" version="1.0.0.6" author="LogicYeh">
    ///         <list type="bullet">
    ///             <item>新增 <see cref="OriginEnum"/></item>
    ///             <item>刪除 TraverseGroup</item>
    ///             <item>刪除 RollDeepDrop</item>
    ///             <item>新增 <see cref="Clutch"/></item>
    ///         </list>
    ///     </revision>
    /// </revisionHistory>
    /// <example>
...
#endif
    {
        ...
        public static APP_Struct Initialization()
        {
            ...
            result.DrillWarehouse = DrillWarehouse.Initialization();
            result.Count = 2;
            return result;
        }
        /// <summary>
