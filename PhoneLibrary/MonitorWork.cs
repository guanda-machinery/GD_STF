...
namespace GD_STD.Phone
{
...
#endif
    {
        ...
        /// </summary>
        [DataMember]
        public double ExportOccupy1;
        /// <summary>
        /// 出口移動料架占用長度 (Field 8)
        /// </summary>
        [DataMember]
        public double ExportOccupy2;
        /// <summary>
        /// 是否材質配配
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// 匯入完成回傳 true ，尚未匯入完成回傳 false。
        /// </remarks>
        [DataMember]
        [MarshalAs(UnmanagedType.I1)]
        public bool ImportProject;
        /// <summary>
        /// 是否秀出出口呼叫台車的訊息
        /// </summary>
        /// <remarks>
        /// SHOW出按鈕回傳 true ，不SHOW出按鈕回傳 false。
        /// </remarks>
        [DataMember]
        [MarshalAs(UnmanagedType.I1)]
        public bool ShowCallTrolley;
        /// <summary>
        /// 出口呼叫台車(搬運)
        /// </summary>
        [DataMember]
        [MarshalAs(UnmanagedType.I1)]
        public bool CallOutTrolley;
        /// <summary>
        /// 續接工作
        /// </summary>
        [DataMember]
