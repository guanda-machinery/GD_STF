...
namespace 測試自動配料
{
    ...
    public class 配料分析
    {
        ...
        public void 自動配料(string projectName)
        {
            ...
            ObservableCollection<SteelPart> steels = serialization.GetPart(partData); //零件序列化檔案
        ...
        public SELECT_ROULETTE Roulette()
        {
            ...
            int value = Convert.ToInt32(strV[strV.Length - 1]);
            return (SELECT_ROULETTE)value;
        }
        ...
        ///// </summary>
        ///// <returns></returns>
        //private int GetSeed(int max)
        //{
        //    int index = random.Next(0, max);//隨機抓取數字
        //}
    }
}
