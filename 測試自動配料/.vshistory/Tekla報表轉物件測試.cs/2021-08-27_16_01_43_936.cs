...
namespace 測試自動配料
{
    ...
    public class 分析
    {
        ...
        public void 報表()
        {
            ...
            foreach (var el in teklaHtemlFactory.KeyValuePairs)
            {
        ...
        public void 創建資料夾()
        {
            ...
            SerializationHelper.GZipSerializeBinary(new ObservableCollection<string>(), ApplicationVM.DirectorySteelAssembly()); //斷面規格列表
