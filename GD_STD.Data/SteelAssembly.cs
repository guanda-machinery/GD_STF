...
namespace GD_STD.Data
{
    ...
    /// </summary>
    [Serializable]
    public class SteelAssembly : IMerge, ITeklaObject, IDrawing, IModelObjectBase, ITekla, IChange, ITypeSettingAssemblyView
    {
        ...
        {
            int result = ID.IndexOf(id);
            if (result != -1)
            {
                return result;
            }
            throw new Exception("找不到物件位置");
        }
        /// <inheritdoc/>
        ...
        ///// </summary>
        ///// <returns></returns>
        //public List<UnfoldSteelAssembly> GetUnfold()
        //{
        //    List<UnfoldSteelAssembly> result = new List<UnfoldSteelAssembly>();
        //    for (int i = 0; i < Phase.Count; i++)
        //    {
        //        UnfoldSteelAssembly unfold = new UnfoldSteelAssembly(this, i); //轉換物件
        //        if (!result.Contains(unfold)) //沒有相同物件
        //        {
        //            result.Add(unfold); //加入到列表
        //            result[result.Count].ID.Add(ID[i]); //加入到物件 ID 集合
        //        }
        //        else
        //        {
        //            unfold.ID.Add(this.ID[i]); //加入到物件 ID 集合
        //        }
        //    }
        //    return result;
        //}
        ...
        ///// 展開的構件
        ///// </summary>
        //public class UnfoldSteelAssembly : ITypeSettingDataView
        //{
        //    /// <summary>
        //    /// 標準建構式
        //    /// </summary>
        //    /// <param name="steel"></param>
        //    /// <param name="index"><see cref="SteelAssembly.ID"/> 陣列位置</param>
        //    public UnfoldSteelAssembly(SteelAssembly steel, int index)
        //    {
        //        AssemblyNumber = steel.Number;
        //        Phase = steel.Phase[index];
        //        ShippingDescription = steel.ShippingDescription[index];
        //        ShippingNumber = steel.ShippingNumber[index];
        //    }
        //    /// <inheritdoc/>
        //    public override bool Equals(object obj)
        //    {
        //        if (obj is UnfoldSteelAssembly value)
        //        {
        //            return value.Phase == Phase &&
        //                       value.ShippingDescription == ShippingDescription &&
        //                       value.ShippingNumber == ShippingNumber &&
        //                       value.AssemblyNumber == AssemblyNumber;
        //        }
        ...
        //        hashCode = hashCode * -1521134295 + EqualityComparer<string>.Default.GetHashCode(ShippingDescription);
        ...
        //    public static bool operator ==(UnfoldSteelAssembly left, UnfoldSteelAssembly right)
        //    {
        //        return EqualityComparer<UnfoldSteelAssembly>.Default.Equals(left, right);
        //    }
