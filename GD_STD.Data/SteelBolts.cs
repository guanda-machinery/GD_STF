...
namespace GD_STD.Data
{
    ...
    {
#pragma warning disable CS1591 // 遺漏公用可見類型或成員 'SteelBolts.SteelBolts()' 的 XML 註解
        public SteelBolts()
#pragma warning restore CS1591 // 遺漏公用可見類型或成員 'SteelBolts.SteelBolts()' 的 XML 註解
        {
        ...
        #region 公開屬性
        [TeklaBom(1)]
#pragma warning disable CS1591 // 遺漏公用可見類型或成員 'SteelBolts.Profile' 的 XML 註解
        public string Profile { get; set; }
#pragma warning restore CS1591 // 遺漏公用可見類型或成員 'SteelBolts.Profile' 的 XML 註解
        /// <summary>
        /// 螺栓類型
        /// </summary>
        [TeklaBom(2)]
...
#pragma warning disable CS1591 // 遺漏公用可見類型或成員 'SteelBolts.operator ==(SteelBolts, SteelBolts)' 的 XML 註解
        public static bool operator ==(SteelBolts left, SteelBolts right)
#pragma warning restore CS1591 // 遺漏公用可見類型或成員 'SteelBolts.operator ==(SteelBolts, SteelBolts)' 的 XML 註解
        {
