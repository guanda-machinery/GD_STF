...
namespace WPFWindowsBase
{
    ...
    public class MessageVM : WPFBase.BaseViewModel
    {
        ...
        public MessageVM(string title, string content, bool leftButtonVisibility, bool rightButtonVisibility, string leftButtonText, string rightButtonText, bool AutoClose, int s)
        {
            Title = title;
            Content = content;
