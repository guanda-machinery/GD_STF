...
namespace WPFSTD105
{
    ...
    public class STDSerialization
    {
        ...
        {
            SerializationHelper.GZipSerializeBinary(materials, ApplicationVM.FileMaterial());//壓縮序列化檔案
        }
        /// <summary>
        /// 取得材質列表
        /// </summary>
        ...
        {
            return SerializationHelper.GZipDeserialize<ObservableCollection<SteelMaterial>>(ApplicationVM.FileMaterial());//解壓縮反序列化
        }
    }
}
