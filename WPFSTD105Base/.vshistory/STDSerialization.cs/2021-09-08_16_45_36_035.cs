...
namespace WPFSTD105
{
    ...
    public class STDSerialization
    {
        ...
        {
            ProjectProperty project = GZipDeserialize<ProjectProperty>($@"{ApplicationVM.FileProjectProperty()}");//解壓縮反序列化
        ...
        public ProjectProperty GetProjectProperty(string path)
        {
            ...
            //ProjectProperty result = new ProjectProperty(project);
            ProjectProperty result = GZipDeserialize<ProjectProperty>($@"{path}");//解壓縮反序列化
            return result;
        }
        /// <summary>
        /// 存取材質列表
        ...
        {
            GZipSerializeBinary(materials, ApplicationVM.FileMaterial());//壓縮序列化檔案
        }
        /// <summary>
        /// 取得材質列表
        /// </summary>
        ...
        {
            return GZipDeserialize<ObservableCollection<SteelMaterial>>(ApplicationVM.FileMaterial());//解壓縮反序列化
        }
        /// <summary>
        /// 取得鑽頭品牌
        /// </summary>
        ...
        public void TEST(ProjectProperty value)
        {
            GZipSerializeBinary(value, "TEST.ASD");//壓縮序列畫檔案
        }
        public ProjectProperty TESTa()
        {
           return GZipDeserialize<ProjectProperty>("TEST.ASD");//壓縮序列畫檔案
        }
    }
}
