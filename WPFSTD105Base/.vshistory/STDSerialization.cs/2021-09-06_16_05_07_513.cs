...
namespace WPFSTD105
{
    ...
    public class STDSerialization
    {
        ...
        public void SetMaterial(ObservableCollection<string> materials)
        {
            SerializationHelper.GZipSerializeBinary(materials, ApplicationVM.ModelFileMaterial());//壓縮序列化檔案
        }
        /// <summary>
        /// 取得材質列表
        /// </summary>
        /// <returns></returns>
        public ObservableCollection<string> GetMaterial()
        {
            return SerializationHelper.GZipDeserialize<ObservableCollection<string>>(ApplicationVM.ModelFileMaterial());//解壓縮反序列化
        }
    }
}
