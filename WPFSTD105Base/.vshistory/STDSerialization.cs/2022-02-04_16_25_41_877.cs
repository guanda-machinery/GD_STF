...
namespace WPFSTD105
{
    ...
    public class STDSerialization
    {
        ...
        /// <param name="dataName">是 <see cref="AbsAttr.GUID"/></param>
        /// <param name="model"></param>
        public void SetPartModel(string dataName, devDept.Eyeshot.Model model) => SetModel($@"{ApplicationVM.DirectoryDevPart()}\{dataName}.dm", dataName, model);
        /// <summary>
        /// 存取素材<see cref="devDept.Eyeshot.Model"/>
        /// </summary>
        /// <param name="dataName"></param>
        /// <param name="model"></param>
        public void SetMaterialModel(string dataName, devDept.Eyeshot.Model model) => SetModel($@"{ApplicationVM.DirectoryMaterial()}\{dataName}.dm", dataName, model);
        ...
        /// 使用 AddToScene 加載場景
        /// </remarks>
        public ReadFile ReadPartModel(string dataName)
        {
            ReadFile result = new ReadFile($@"{ApplicationVM.DirectoryDevPart()}\{dataName}.dm", new FileSerializerExt(devDept.Serialization.contentType.GeometryAndTessellation));
            result.DoWork();
            return result;
        }
