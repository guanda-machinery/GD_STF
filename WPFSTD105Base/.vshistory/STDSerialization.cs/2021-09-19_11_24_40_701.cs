...
namespace WPFSTD105
{
    ...
    public class STDSerialization
    {
        ...
        public void SetModel(string dataName, devDept.Eyeshot.Model model)
        {
        ...
        /// <summary>
        /// 載入 <see cref="devDept.Eyeshot.Model"/>
        /// </summary>
        /// <param name="dataName">是 <see cref="AbsAttr.GUID"/></param>
        /// <param name="model"></param>
        /// <remarks>
        ...
        {
            ReadFile result = new ReadFile($@"{ApplicationVM.DirectoryDevPart()}\20464d9a-22c8-432b-9c81-923942ab5a01.dm", devDept.Serialization.contentType.GeometryAndTessellation);
            result.DoWork();
            return read
        }
    }
