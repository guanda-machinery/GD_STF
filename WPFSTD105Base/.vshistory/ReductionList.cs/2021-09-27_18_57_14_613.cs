...
namespace WPFSTD105
{
    ...
    public class ReductionList
    {
        ...
        public void Add(Reduction reduction3D, Reduction reduction2D)
        {
        ...
        /// 使用虛擬鍵盤會自動加入刪除動作在列表內
        ///  </remarks>
        public void AddContinuous(List<Entity> entities3D, List<Entity> entities2D)
        {
        ...
        public void Next()
        {
            if (_Index >= Reductions3D.Count - 1)
            {
#if DEBUG
