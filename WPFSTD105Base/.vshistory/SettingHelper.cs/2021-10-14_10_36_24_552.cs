...
namespace WPFSTD105
{
    ...
    public static class SettingHelper
    {
        ...
        public static GD_STD.Phone.MechanicalSetting GetMechanicalSetting()
        {
            ...
            {
                Vehicle_Length = Default.Vehicle_Length,
                Vehicle_Raised_Length = Default.Vehicle_Raised_Length,
                Vehicle_Origin_To_Location_Point_Length = Default.Vehicle_Origin_To_Location_Point_Length,
                Traverse_Sort_Total_Length = Default.Traverse_Sort_Total_Length,
                In_Traverse_Limit_Total_Length = Default.In_Traverse_Limit_Total_Length
            };
