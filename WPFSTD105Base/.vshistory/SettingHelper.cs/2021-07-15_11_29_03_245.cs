    ...
    public static class SettingHelper
    {
        ...
        public static List<Axis4D> ToAxis4D(string str)
        {
            ...
            for (int i = 0; i < vs.Length; i++)
            {
                ...
                if (value.Length == 4)
                {
                    double xv = 0, yv = 0, zv = 0, masterPhase = 0;
                    double.TryParse(value[0], out xv);
                    double.TryParse(value[1], out yv);
                    double.TryParse(value[2], out zv);
                    double.TryParse(value[3], out masterPhase);
        ...
        {
            MechanicalSetting result = new MechanicalSetting();
            ...
            result.Middle = new MiddleAxisSetting()
            {
                ...
                BorrowMeasuringPosition = ToAxis3D(Default.MiddleBorrowMeasuringPosition),
                BorrowSensorZero = Default.MiddleBorrowSensorZero,
