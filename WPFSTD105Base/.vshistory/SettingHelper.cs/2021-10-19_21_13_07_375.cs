    ...
    public static class SettingHelper
    {
        ...
        public static GD_STD.Phone.MechanicalSetting GetMechanicalSetting()
        {
            ...
            result.Hand = new HandSetting()
            {
                ...
                ArmInDownSensorToForntLength = Default.ArmInDownSensorToForntLength,
            ...
            {
                CarLength = Default.Vehicle_Length,
                CarRaisedLength = Default.Vehicle_Raised_Length,
                OriginToLocationPoint = Default.Vehicle_Origin_To_Location_Point_Length,
                SortTotalLength = Default.Traverse_Sort_Total_Length,
                Limit = Default.In_Traverse_Limit_Total_Length,
                SortCorrection = Default.Sort_Traverse_Correction,
                ToArmSideCorrection = Default.To_ArmSide_Traverse_Correction
            };
