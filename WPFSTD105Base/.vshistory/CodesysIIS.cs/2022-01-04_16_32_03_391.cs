...
namespace WPFSTD105
{
    ...
    public static class CodesysIIS
    {
        ...
        /// 讀取 Codesys 記憶體 (雙向通訊)
        /// </summary>
        public static ReadMemoryDuplexClient ReadMemoryDuplex = new ReadMemoryDuplexClient(new InstanceContext(new ReadMemoryCallbackHandler()));
        /// <summary>
        /// 軟體關閉
        /// </summary>
        ...
        public static void Open()
        {
            try
            {
                ...
                if (!host.PCOpen)
                {
                    ...
                    {
                        HandAuto = Optional.Default.HandAuto,//自動手臂選配
                        /*刀庫選配*/
                        LeftEntrance = Optional.Default.LeftEntrance,
                        LeftExport = Optional.Default.LeftExport,
                        Middle = Optional.Default.Middle,
                        RightEntrance = Optional.Default.RightEntrance,
                        RightExport = Optional.Default.RightExport,
                        AutoDrill = Optional.Default.AutoDrill,//自動測刀長
                        EntranceTraverseNumber = Optional.Default.EntranceTraverseNumber, //入口橫移料架選配數量
                        ExportTraverseNumber = Optional.Default.ExportTraverseNumber, //出口橫移料架選配數量
                        StepAsideCount = 2, //手臂靠邊數量
                        ExportTraverseRoute = Optional.Default.ExportTraverseRoute,//出口移動料架形狀
                        ExportTraverseAuto = Optional.Default.ExportTraverseAuto,//出口橫移自動選配
                        EntranceTraverseAuto = Optional.Default.EntranceTraverseAuto,
                        DrawLine = Optional.Default.DrawLine,
                        MillingCutter = Optional.Default.MillingCutter,
                        Tapping = Optional.Default.Tapping,
                        ExportTraverseSnsorCount = Optional.Default.ExportTraverseSnsorCount,
                        ExportTraverseLeftSnsorCount = Optional.Default.ExportTraverseLeftSnsorCount,
                        ExportTraverseRightSnsorCount = Optional.Default.ExportTraverseRightSnsorCount,
                    };
