...
namespace WPFSTD105
{
    ...
    public static class CodesysIIS
    {
        ...
        /// 讀取 Codesys 記憶體 (雙向通訊)
        /// </summary>
        public static ReadMemoryDuplexClient ReadMemoryDuplexC = new ReadMemoryDuplexClient(new InstanceContext(new ReadMemoryCallbackHandler()));
        /// <summary>
        /// 軟體關閉
        /// </summary>
