...
namespace WPFSTD105
{
    ...
    public static class CodesysIIS
    {
        ...
        /// </summary>
        public static MemorClient CodesysMemor { get; set; }
        /// <summary>
        /// 寫入 Codesys 記憶體
        /// </summary>
        public static WriteMemorClient WriteCodesysMemor { get; set; }
        /// <summary>
        /// 讀取 Codesys 記憶體
        /// </summary>
        public static ReadMemorClient ReadCodesysMemor { get; set; }
        /// <summary>
        /// 手機連線狀態
        /// </summary>
        public static PhoneConnectDuplexClient PhoneOperating { get; set; }
        /// <summary>
        /// 軟體關閉
        /// </summary>
        ...
        public static void Open()
        {
            try
            {
                ...
                PhoneOperating = new PhoneConnectDuplexClient(new InstanceContext(new CallbackHandler()));
                CodesysMemor.Open();
                ...
                if (Default.DrillWarehouse == null)
                    DrillWarehouseInitialization(mecOptional);
