...
namespace WPFSTD105.Model
{
    ...
    public static class Expand
    {
        ...
        /// 組合零件變成素材
        /// </summary>
        public static void AssemblyPart(this devDept.Eyeshot.Model model, string partNumber)
        {
            STDSerialization ser = new STDSerialization(); //序列化處理器
            ObservableCollection<MaterialDataView> materialDataViews = ser.GetMaterialDataView(); //序列化列表
            int index = materialDataViews.FindIndex(el => el.MaterialNumber == partNumber);//序列化的列表索引
            ...
            DrawCutMesh(parts[0], model, start, material.LengthList[material.LengthIndex] + material.StartCut + material.EndCut, ent);
        ...
        public static void LoadNcToModel(this devDept.Eyeshot.Model model, string dataName)
        {
            ...
            ser.SetModel(dataName, model);//儲存 3d 視圖
