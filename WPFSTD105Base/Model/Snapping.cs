        ...
        public SnapPoint[] GetSnapPoints(System.Drawing.Point point)
        {
            ...
            if (entity != null)
            {
                ...
                else if (entity is Mesh mesh) //TODO : 實體鎖點
                {
                    ...
                    else if (entity.EntityData is BoltAttr)
                    {
                        Point3D boxMin, boxMax;
                        Utility.ComputeBoundingBox(null, entity.Vertices, out boxMin, out boxMax);
                        result.Add(new SnapPoint((boxMin + boxMax) / 2, objectSnapType.Center));//加入圓心座標
                    }
                }
            }
...
#pragma warning disable CS1591 // 遺漏公用可見類型或成員 'ModelExt.snapSymbolSize' 的 XML 註解
        public int snapSymbolSize { get; set; } = 12;
#pragma warning restore CS1591 // 遺漏公用可見類型或成員 'ModelExt.snapSymbolSize' 的 XML 註解
        /// <summary>
        /// 畫十字。 用圓圈繪製表示單個點
        /// </summary>
        ...
        {
#pragma warning disable CS1591 // 遺漏公用可見類型或成員 'ModelExt.SnapPoint.Type' 的 XML 註解
            public objectSnapType Type;
#pragma warning restore CS1591 // 遺漏公用可見類型或成員 'ModelExt.SnapPoint.Type' 的 XML 註解

#pragma warning disable CS1591 // 遺漏公用可見類型或成員 'ModelExt.SnapPoint.SnapPoint()' 的 XML 註解
            public SnapPoint() : base()
#pragma warning restore CS1591 // 遺漏公用可見類型或成員 'ModelExt.SnapPoint.SnapPoint()' 的 XML 註解
            {
                Type = objectSnapType.None;
            }

#pragma warning disable CS1591 // 遺漏公用可見類型或成員 'ModelExt.SnapPoint.SnapPoint(Point3D, ModelExt.objectSnapType)' 的 XML 註解
            public SnapPoint(Point3D point3D, objectSnapType objectSnapType) : base(point3D.X, point3D.Y, point3D.Z)
#pragma warning restore CS1591 // 遺漏公用可見類型或成員 'ModelExt.SnapPoint.SnapPoint(Point3D, ModelExt.objectSnapType)' 的 XML 註解
            {
                this.Type = objectSnapType;
            }

#pragma warning disable CS1591 // 遺漏公用可見類型或成員 'ModelExt.SnapPoint.ToString()' 的 XML 註解
            public override string ToString()
#pragma warning restore CS1591 // 遺漏公用可見類型或成員 'ModelExt.SnapPoint.ToString()' 的 XML 註解
            {
