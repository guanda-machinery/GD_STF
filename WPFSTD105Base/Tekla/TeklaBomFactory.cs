...
namespace WPFSTD105.Tekla
{
    ...
    public class TeklaBomFactory
    {
        ...
        public TeklaBomFactory(string bomPath)
        {
            ...
            Profile.Add(OBJETC_TYPE.TUBE, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\TUBE.inp"));
            Profile.Add(OBJETC_TYPE.H, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\H.inp"));
            Profile.Add(OBJETC_TYPE.I, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\I.inp"));
            Profile.Add(OBJETC_TYPE.LB, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\LB.inp"));
            Profile.Add(OBJETC_TYPE.BT, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\BT.inp"));
            Profile.Add(OBJETC_TYPE.CT, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\CT.inp"));
            Profile.Add(OBJETC_TYPE.T, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\T.inp"));
            Profile.Add(OBJETC_TYPE.TURN_BUCKLE, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\TURN_BUCKLE.inp"));
            Profile.Add(OBJETC_TYPE.WELD, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\WELD.inp"));
            Profile.Add(OBJETC_TYPE.SA, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\SA.inp"));
            Profile.Add(OBJETC_TYPE.GRATING, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\GRATING.inp"));
            Profile.Add(OBJETC_TYPE.HNUT, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\HNUT.inp"));
            Profile.Add(OBJETC_TYPE.NUT, SerializationHelper.Deserialize<ObservableCollection<SteelAttr>>($@"{ApplicationVM.DirectoryPorfile()}\NUT.inp"));
        }
