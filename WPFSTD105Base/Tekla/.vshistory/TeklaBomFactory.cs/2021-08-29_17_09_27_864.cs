...
namespace WPFSTD105.Tekla
{
    ...
    public class TeklaHtemlFactory
    {
        ...
        /// 軟體缺少的斷面規格列表
        /// </summary>
        public Dictionary<OBJETC_TYPE, ObservableCollection<SteelAttr>> LackProfile;
        /// <summary>
        /// 軟體缺少的材質
        /// </summary>
        public ObservableCollection<string> LackMaterial;
        ...
        /// 系統內的斷面規格列表
        /// </summary>
        private Dictionary<OBJETC_TYPE, ObservableCollection<SteelAttr>> _Profile;
        /// <summary>
        /// 系統內的材質
        /// </summary>
        ...
        {
            _Material = SerializationHelper.GZipDeserialize<ObservableCollection<string>>(ApplicationVM.ModelFileMaterial()); //系統內材質序列化檔案
            GetProfile(ref _Profile);
            GetProfile(ref LackProfile);
        }
        ...
        private void GetProfile(ref Dictionary<OBJETC_TYPE, ObservableCollection<SteelAttr>> keyValuePairs)
        {
            keyValuePairs.Add(OBJETC_TYPE.BH, new ObservableCollection<SteelAttr>());
            keyValuePairs.Add(OBJETC_TYPE.RH, new ObservableCollection<SteelAttr>());
            keyValuePairs.Add(OBJETC_TYPE.BOX, new ObservableCollection<SteelAttr>());
            keyValuePairs.Add(OBJETC_TYPE.CH, new ObservableCollection<SteelAttr>());
            keyValuePairs.Add(OBJETC_TYPE.L, new ObservableCollection<SteelAttr>());
        }
        #endregion
