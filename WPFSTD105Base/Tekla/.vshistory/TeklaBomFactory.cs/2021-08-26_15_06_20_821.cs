...
namespace WPFSTD105.Tekla
{
    ...
    public class TeklaHtemlFactory
    {
        ...
        /// 次件列表
        /// </summary>
        private Dictionary<string, object> _KeyValuePairs = new Dictionary<string, object>();
                ...
                while ((line = reader.ReadLine()) != null)
                {
                    ...
                    if (number > 2)
                    {
                        ...
                        else if (objType == Father.GetType())//如果是構件
                        {
                            ...
                            {
                                if (steels.ElementAt(0).Equals(Father)) //使用雜湊確認物件相同
                                {
                        ...
                        {
                            //if (_KeyValuePairs.ContainsKey((ipr)))
                            {
