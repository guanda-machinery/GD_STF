...
namespace WPFSTD105.Attribute
{
    ...
    public class SteelAttr : AbsAttr, ISteelAttr
    {
        ...
        /// <inheritdoc/>
        [Html("AssemblyNumber")]
        public List<string> AsseNumbers { get; set; }
        /// <inheritdoc/>
        ...
        {
            return Combination(PartNumbers);
        }
        /// <inheritdoc/>
        public string GetAsseNumber()
        {
            return Combination(AsseNumbers);
        }
        private Func<List<string>, string> Combination = (list) =>
        {
