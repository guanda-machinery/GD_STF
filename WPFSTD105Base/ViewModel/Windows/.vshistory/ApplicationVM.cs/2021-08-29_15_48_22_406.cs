    ...
    public class ApplicationVM : WPFBase.BaseViewModel
    {
        ...
        public static bool IsModel(string modelPath)
        {
            if (Directory.Exists($"{modelPath}\\{ModelPath.Nc}")) // NC 資料夾
                if (Directory.Exists($"{modelPath}\\{ModelPath.DevMaterial}")) //存放素材序列化的資料夾
        ...
        public static string DirectoryMaterial()
        {
            ...
            if (projectName != null)
                return $@"{Properties.SofSetting.Default.LoadPath}\{ApplicationViewModel.ProjectName}\{ModelPath.DevMaterial}";
        ...
        public static string FileProfileList()
        {
            ...
            if (projectName != null)
                return FileProfileList($@"{Properties.SofSetting.Default.LoadPath}\{ApplicationViewModel.ProjectName}");
