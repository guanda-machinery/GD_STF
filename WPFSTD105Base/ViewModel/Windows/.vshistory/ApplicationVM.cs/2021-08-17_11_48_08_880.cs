...
namespace WPFSTD105
{
    ...
    public class ApplicationVM : WPFBase.BaseViewModel
    {
        ...
        /// <returns>
        /// 目前用戶建立或開啟的專案模型資料夾路徑
        /// <para>路徑組合 : <see cref="ModelPath.Models"/>\\<see cref="ProjectName"/></para>
        /// </returns>
        /// <remarks>
        /// 這是一個專案的主要目錄資料夾，
        /// 裡面存放著
        ...
        public static string DirectoryModel()
        {
            ...
            if (projectName != null)
                return $"{ModelPath.Models}\\{ApplicationViewModel.ProjectName}";
        ...
        /// </summary>
        /// <returns>
        /// 路徑組合 : <see cref="ModelPath.Models"/>\\<see cref="ProjectName"/>\\<see cref="ModelPath.Nc"/>
        /// </returns>
        /// <remarks>
        ...
        public static string DirectoryNc()
        {
            ...
            if (projectName != null)
                return $@"{ModelPath.Models}\{ApplicationViewModel.ProjectName}\{ModelPath.Nc}";
        ...
        /// </summary>
        /// <returns>
        /// 目前用戶建立或開啟的專案模型資料夾內素材檔案的資料夾路徑
        /// <para>
        /// 路徑組合 : <see cref="ModelPath.Models"/>\\<see cref="ProjectName"/>\\<see cref="ModelPath.Material"/>
        /// </para> 
        /// </returns>
        /// <remarks>
        /// 上一層目錄是 <see cref="DirectoryModel"/>
        ...
        public static string DirectoryMaterial()
        {
            ...
            if (projectName != null)
                return $@"{ModelPath.Models}\{ApplicationViewModel.ProjectName}\{ModelPath.Material}";
        ...
        public static string DirectoryDevPart()
        {
            ...
            if (projectName != null)
                return $@"{ModelPath.Models}\{ApplicationViewModel.ProjectName}\{ModelPath.Dev_Part}";
        ...
        public static string PartList()
        {
            ...
            if (projectName != null)
                return $@"{ModelPath.Models}\{ApplicationViewModel.ProjectName}\part.lis";
