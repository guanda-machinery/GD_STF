...
namespace WPFSTD105
{
    ...
    public class WindowsVM : WPFBase.WindowsViewModel
    {
        ...
        */
        ...
        /// </summary>
        /// <returns></returns>
        private WPFBase.RelayParameterizedCommand SaveAsProject()
        {
            return new WPFBase.RelayParameterizedCommand(el =>
            {
                ...
                System.IO.File.Copy($@"{ApplicationVM.DirectoryModel()}", $@"{vm.ResultPath}\{ApplicationViewModel.ProjectProperty.Name}");
            }) ;
        }
        /// <summary>
        /// 確定另存專案命令
        ...
        public WPFBase.RelayCommand SaveAs()
        {
            return new WPFBase.RelayCommand(() =>
            {
