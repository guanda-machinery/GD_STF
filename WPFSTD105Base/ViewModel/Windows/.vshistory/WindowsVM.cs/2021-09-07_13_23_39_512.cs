...
namespace WPFSTD105
{
    ...
    public class WindowsVM : WPFBase.WindowsViewModel
    {
        ...
        */
        ...
        private WPFBase.RelayParameterizedCommand OutProjectName()
        {
            return new WPFBase.RelayParameterizedCommand(e =>
            {
                OpenOldFileDialogViewModel vm = (OpenOldFileDialogViewModel)e;
        ...
        public WPFBase.RelayParameterizedCommand SaveAs()
        {
            ...
            {
                OpenOldFileDialogViewModel vm = (OpenOldFileDialogViewModel)el;
    ...
    /// </summary>
    [POCOViewModel]
    public class OpenOldFileDialogViewModel
    {
        /// <summary>
        /// 視窗上方說明
        /// </summary>
