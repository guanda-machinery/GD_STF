...
namespace WPFSTD105
{
    ...
    /// </summary>
    public class WindowsVM : AbsBaseWindowView
    {
        /// <summary>
        /// 控制選擇檔案視窗是否可見
        /// </summary>
        ...
        ///// 移動料架命令
        ///// </summary>
        //public ICommand RacksOperationCommand { get; set; }
        //private WPFBase.RelayCommand RacksOperation()
        //{
        //    return new WPFBase.RelayCommand(() =>
        //    {
        //        PanelButton panelButton = ApplicationViewModel.PanelButton;
        //        if (!panelButton.EntranceRack && !panelButton.EntranceRack)
        //        {
        //            panelButton = StateClear(ApplicationViewModel.PanelButton);
        ...
        */
        ...
        private WPFBase.RelayCommand MainAxisMode()
        {
            return new WPFBase.RelayCommand(() =>
            {
                ...
                if (!ApplicationViewModel.PanelButton.MainAxisMode)
                {
                    ...
                    _.AxisStop = true;
                    //開啟附屬功能區域
                    SpindleFuctionControl = true;
                }
                else
                {
                    _ = StateClear(ApplicationViewModel.PanelButton);
                    //關閉附屬功能區域
                    SpindleFuctionControl = false;
                }
                WriteCodesysMemor.SetPanel(_);//寫入操控面板 IO
            });
        }
        ...
        protected override WPFBase.RelayParameterizedCommand OpenProject()
        {
            return new WPFBase.RelayParameterizedCommand(e =>
            {
                ...
                else if (projectName == e.ToString())
                {
                    return;
                }
                else
        ...
        protected override WPFBase.RelayCommand ImportFile()
        {
            return new WPFBase.RelayCommand(() =>
            {
                base.ImportFile().Execute(null);
                if (ImportFileControl)
                    ImportFileControl = false;
                else
                    ImportFileControl = true;
            });
        }
        /// <summary>
        /// 呼叫專案修改視窗命令 
        ...
        /// 關閉附屬功能視窗
        /// </summary>
        public ICommand CloseSubWindowsCommand { get; set; }
        /// <summary>
        /// 關閉附屬功能視窗功能
        /// </summary>
        /// <returns></returns>
        private WPFBase.RelayCommand CloseSubWindow()
        {
            return new WPFBase.RelayCommand(() =>
            {
                SpindleFuctionControl = false;
        ...
        /// 顯示機台功能
        /// </summary>
        public ICommand MachineFuctionCommand { get; set; }
        private WPFBase.RelayCommand MachineFuction()
        {
            return new WPFBase.RelayCommand(() =>
            {
                if (MachineFuctionControl)
                    CleanCustomVariable();
                else
                {
                    CleanCustomVariable();
                    MachineFuctionControl = true;
                }
            });
        }
        /// <summary>
        /// 顯示軟體設定
        /// </summary>
        public ICommand SettingsFuctionCommand { get; set; }
        private WPFBase.RelayCommand SettingsFuction()
        {
            return new WPFBase.RelayCommand(() =>
            {
                if (SettingsFuctionControl)
                    CleanCustomVariable();
                else
                {
                    CleanCustomVariable();
                    SettingsFuctionControl = true;
                }
            });
        }
        /// <summary>
        ...
        private WPFBase.RelayCommand ProjectManager()
        {
            return new WPFBase.RelayCommand(() =>
            {
                if (ProjectManagerControl)
                    CleanCustomVariable();
                else
                {
                    CleanCustomVariable();
                    ProjectManagerControl = true;
                }
            });
        }
        /// <summary>
        /// 顯示多國語言
        /// </summary>
        public ICommand LanguageSwitchCommand { get; set; }
        private WPFBase.RelayCommand LanguageSwitch()
        {
            return new WPFBase.RelayCommand(() =>
            {
        ...
        /// 主軸功能
        /// </summary>
        public bool SpindleFuctionControl { get; set; }
        /// <summary>
        /// 機台功能
        /// </summary>
        public bool MachineFuctionControl { get; set; }
        /// <summary>
        /// 設定功能
        /// </summary>
        public bool SettingsFuctionControl { get; set; }
        /// <summary>
        /// 專案管理
        /// </summary>
        public bool ProjectManagerControl { get; set; }
        /// <summary>
        /// 多國語言
        /// </summary>
        public bool LanguageSwitchControl { get; set; }
        ...
        public WindowsVM(Window window) : base(window)
        {
            ...
            MachineFuctionCommand = MachineFuction();
            SettingsFuctionCommand = SettingsFuction();
        ...
        //清除自訂狀態
        private void CleanCustomVariable()
        {
            MachineFuctionControl = false;
            SettingsFuctionControl = false;
            ProjectManagerControl = false;
            LanguageSwitchControl = false;
        }
        #endregion
    }
}
