    ...
    public class ObSettingVM : WPFBase.BaseViewModel
    {
        ...
        public int ProfileIndex
        {
            ...
            set
            {
                ...
                steelAttr.AssemblyNumber = SteelAttr.AssemblyNumber;
        ...
        /// <summary>
        /// 材質類型<see cref="GD_STD.Enum.MATERIAL"/>索引值
        /// </summary>
        public int MaterialIndex
        {
            ...
            set
            {
                ...
                SteelAttr.Material = (GD_STD.Enum.MATERIAL)value;
#if DEBUG
        ...
        public void WriteSteelAttr(SteelAttr steelAttr)
        {
            ...
            MaterialIndex = (int)steelAttr.Material;
