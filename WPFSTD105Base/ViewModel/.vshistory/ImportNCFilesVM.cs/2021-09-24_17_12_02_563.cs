...
namespace WPFSTD105
{
    ...
    /// 匯入檔案VM
    /// </summary>
    public class ImportNCFilesVM : WPFWindowsBase.BaseViewModel, IProjectProperty, IChildWin
    {
        /// <summary>
        /// 啟動畫面管理器
        /// </summary>
        ...
        /// <inheritdoc/>
        public ICommand Close { get; set; } = new WPFWindowsBase.RelayCommand(() => { CommonViewModel.Close.Execute(null); });
