...
namespace WPFSTD105
{
    ...
    public class ImportNCFilesVM : WPFWindowsBase.BaseViewModel, IProjectProperty
    {
        ...
        public ImportNCFilesVM()
        {
            ...
            _VM = new DXSplashScreenViewModel();
        ...
        private WPFWindowsBase.RelayCommand Save()
        {
            return new WPFWindowsBase.RelayCommand(() =>
            {
                ...
                if (BomPath != string.Empty)//如果有選擇報表路徑
                {
                    ...
                    ScreenManager.ViewModel.Status = "轉換 Tekla Structures 物件中 ...";
        ...
        /// <summary>
        /// 為 SplashScreenManager 指定數據和選項的視圖模型。
        /// </summary>
        public DXSplashScreenViewModel _VM { get; set; }
        /// <summary>
        /// 載入 tekla 
        /// </summary>
