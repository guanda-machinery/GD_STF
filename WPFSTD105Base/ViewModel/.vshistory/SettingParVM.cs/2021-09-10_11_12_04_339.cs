        ...
        public WPFBase.RelayParameterizedCommand UpdateTree()
        {
            return new WPFBase.RelayParameterizedCommand(e =>
            {
                ...
                if (e is SteelAttr steelAttr)
                {
                    ...
                    SteelAttr update = new SteelAttr { H = InsertionData[0].Value, W = InsertionData[1].Value, t1 = InsertionData[2].Value, t2 = InsertionData[3].Value }; //更新後物件
                    back[backIndex] = update; //變更模型資料
