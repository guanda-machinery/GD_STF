    ...
    public class SettingParVM : WPFBase.BaseViewModel
    {
        ...
        private WPFBase.RelayCommand SaveDrillBrands()
        {
            return new WPFBase.RelayCommand(() =>
            {
                ...
                UnusedSelected = new ObservableCollection<_drillSetting>(UnusedSelected);
            });
        }
        /// <summary>
        /// 刪除材質
        ...
        public class _drillSetting : WPFBase.BaseViewModel
        {
            ...
            public string SettingName
            {
                ...
                {
                    settingName = value;
                    settingIndex = SofSetting.Default.DrillBrands.IndexOf(el => el.DataName == value);
                    Dia = SofSetting.Default.DrillBrands[settingIndex].Dia;
                    Rpm = SofSetting.Default.DrillBrands[settingIndex].Rpm;
                    FeedQuantity = SofSetting.Default.DrillBrands[settingIndex].FeedQuantity;
                    Length = SofSetting.Default.DrillBrands[settingIndex].HolderLength + SofSetting.Default.DrillBrands[settingIndex].DrillLength;
                    Name = SofSetting.Default.DrillBrands[settingIndex].Name;
                    f = SofSetting.Default.DrillBrands[settingIndex].f;
                }
            }
            /// <summary>
            /// 刀庫位置
