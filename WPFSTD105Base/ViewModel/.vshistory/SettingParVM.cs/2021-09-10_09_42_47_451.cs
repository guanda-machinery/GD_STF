    ...
    public class SettingParVM : WPFBase.BaseViewModel
    {
        ...
        private WPFBase.RelayParameterizedCommand UpdateMaterial()
        {
            return new WPFBase.RelayParameterizedCommand(e =>
            {
                ...
                int systemIndex = system.IndexOf(el => el.Name == _Materials[MatrialIndex].Name);//找出系統有相同名稱的位置
                if (system.IndexOf(el => el.Name == _Materials[MatrialIndex].Name) != -1) //如果系統有相同材質名稱
                {
