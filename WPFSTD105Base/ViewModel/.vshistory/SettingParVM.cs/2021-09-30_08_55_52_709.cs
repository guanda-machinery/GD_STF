...
namespace WPFSTD105.ViewModel
{
    ...
    public class SettingParVM : WPFBase.BaseViewModel
    {
        ...
        public class _drillSetting : WPFBase.BaseViewModel
        {
            ...
            public ObservableCollection<DrillBrand> Brands { get; set; }
            private DrillSetting _DrillSetting;
            private int index;

            public DrillSetting DrillSetting { get => _DrillSetting; set => _DrillSetting = value; }
            public int Index
            {
                get => index;
                set
            ...
            public string DataName
            {
                ...
                set
                {
                    ...
                    if (value != "") //如果值不是空的
                    {
                        int index = Brands.IndexOf(el => el.DataName == value);//找出參數索引位置
                        Name = Brands[index].Name;
                        _DrillSetting.Dia = Brands[index].Dia;
                        _DrillSetting.DrillType = Brands[index].DrillType;
                        _DrillSetting.FeedQuantity = Brands[index].FeedQuantity;
                        _DrillSetting.KnifeHandle = Brands[index].HolderLength;
                        _DrillSetting.Length = Brands[index].DrillLength;
                        _DrillSetting.Rpm = Brands[index].Rpm;
                    }
                }
            }
            ///// <summary>
            ...
            public _drillSetting(DrillSetting drillSetting)
            {
                ...
                Brands = new STDSerialization().GetDrillBrands();
                ...
                //this.SumLength = drillSetting.SumLength;
            }
