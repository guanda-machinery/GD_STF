...
namespace WPFSTD105.ViewModel
{
    ...
    public class SettingParVM : WPFBase.BaseViewModel
    {
        ...
        /// <summary>
        /// 選擇中<see cref="DrillWarehouse.RightEntrance"/>命令
        /// </summary>
        ...
        public WPFBase.RelayCommand Delete()
        {
            return new WPFBase.RelayCommand(() =>
            {
        ...
        /// 使用者刀庫設定
        /// </summary>
        private DrillWarehouse _DrillWarehouse { get; set; }
        /// <summary>
        /// 油壓系統
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        private void Location(DrillWarehouse drillSettings)
        {
