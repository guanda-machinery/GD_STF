...
namespace WPFSTD105.ViewModel
{
    ...
    public class SettingParVM : WPFBase.BaseViewModel
    {
        ...
        public WPFBase.RelayParameterizedCommand UpdateTree()
        {
            return new WPFBase.RelayParameterizedCommand(e =>
            {
                ...
                if (e is SteelAttr steelAttr)
                {
                    ...
                    back[backIndex] =SerializationHelper.Clone(update); //變更模型資料
                    showPropertyInfo.SetValue(this, SerializationHelper.Clone(back));//賦予到顯示列表
        ...
        /// 選擇的參數檔案
        /// </summary>
        public SteelAttr SelectSteelAtte { get => selectSteelAtte; set => selectSteelAtte = value; }
        /// <summary>
        /// 顯示Beam 2D圖
        /// </summary>
        ...
        private SteelAttr selectSteelAtte = new SteelAttr();
