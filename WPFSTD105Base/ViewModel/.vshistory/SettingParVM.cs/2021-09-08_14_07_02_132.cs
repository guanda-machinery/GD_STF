...
namespace WPFSTD105.ViewModel
{
    ...
    public class SettingParVM : WPFBase.BaseViewModel
    {
        ...
        public SettingParVM()
        {
            ...
            SaveProfileCommand = SaveProfile();
        ...
        public WPFBase.RelayParameterizedCommand SaveProfile()
        {
            return new WPFBase.RelayParameterizedCommand(el =>
            {
                ...
                PropertyInfo showPropertyInfo = this.GetType().GetProperty(strType, InstanceBindFlags);//反射在畫面顯示的資料列表
                PropertyInfo backPropertyInfo = this.GetType().GetProperty($@"_{strType}");//反射在背景的資料列表欄位
        ...
        public void LoadProfile()
        {
            ...
            _Materials.ForEach(el => Materials.Add(el.Name));
