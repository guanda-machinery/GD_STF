...
namespace WPFSTD105.ViewModel
{
    ...
    public class SettingParVM : WPFBase.BaseViewModel
    {
        ...
        /// 材質讀取到的資料列表
        /// </summary>
        public ObservableCollection<SteelMaterial> _Material { get; set; }
        #endregion
        ...
        /// 材質要顯示的集合
        /// </summary>
        public ObservableCollection<string> Material { get; set; } = new ObservableCollection<string>();
        /// <summary>
        /// 綁定儲存位置視窗顯示
        /// </summary>
        ...
        /// 材質選擇索引列表
        /// </summary>
        public int MatrialIndex { get => _MatrialIndex; set => _MatrialIndex = value; }
        #endregion
        ...
        public void LoadProfile()
        {
            ...
            _Material = ser.GetMaterial();
            _Material.ForEach(el => Material.Add(el.Name));
