...
namespace WPFSTD105.ViewModel
{
    ...
    public class RacksOperationVM : WPFWindowsBase.BaseViewModel
    {
        ...
        /// 入口移動料架上升或下降數量
        /// </summary>
        private int EntranceRackRiseCount = 2;
        /// <summary>
        /// 出口移動料架上升或下降數量
        /// </summary>
        private int ExportRiseCount = 2;
        ...
        {
            get => SelectedRacks == RACKS_SELECTED.Entrance ? EntranceRackRiseCount : ExportRiseCount;
            set
            {
                if (SelectedRacks == RACKS_SELECTED.Entrance)
                {
                    EntranceRackRiseCount = value;
                }
                else
                {
                    ExportRiseCount = value;
                }
            }
        }
        /// <summary>
