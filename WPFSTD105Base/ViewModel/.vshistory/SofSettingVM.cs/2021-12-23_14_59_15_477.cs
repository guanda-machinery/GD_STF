...
namespace WPFSTD105.ViewModel
{
    ...
    public class SofSettingVM : BaseViewModel
    {
        ...
        private ICommand ConvertStringToIndex()
        {
            ...
            {
                string FontName = SofSetting.Default.FontFamily;
        ...
        {
            //存取機械參數設定檔
            MecSetting.ArmFeedOriginToOutUpRoll.Save();
            //取得 Codesys 本機狀態
            ...
            MecSetting.ArmFeedOriginToOutUpRoll.DrillWarehouse = SettingHelper.SetPosition(MecSetting.ArmFeedOriginToOutUpRoll.DrillWarehouse);
            WriteCodesysMemor.SetDrillWarehouse(MecSetting.ArmFeedOriginToOutUpRoll.DrillWarehouse);
            MecSetting.ArmFeedOriginToOutUpRoll.Save();
            CodesysMemor.Create(host, MecSetting.ArmFeedOriginToOutUpRoll.Company);
        });
        /// <summary>
        /// 觸發機械參數還原命令
        /// </summary>
        ...
        {
            Properties.MecSetting.ArmFeedOriginToOutUpRoll.Reset();
        });
        /// <summary>
        /// 觸發軟體存取設定
        /// </summary>
