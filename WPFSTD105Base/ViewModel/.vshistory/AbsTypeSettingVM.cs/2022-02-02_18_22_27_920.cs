...
namespace WPFSTD105
{
    ...
    public abstract class AbsTypeSettingVM : WPFBase.BaseViewModel
    {
        ...
        public AbsTypeSettingVM()
        {
            ...
            AutoCommand = new WPFBase.ParameterizedCommandAync(async (obj) =>
            {
                await AutoMatchAsync(obj);
            });
        }
        #region 命令
        /// <summary>
        ...
        /// 自動排版命令
        /// </summary>
        public WPFBase.IAsyncCommand AutoCommand { get; set; }
        ...
        #endregion
        #region 私有方法
        private  Task AutoMatchAsync(object obj)
        {
            unsafe
            {
