    ...
    public abstract class AbsTypeSettingVM : WPFBase.BaseViewModel
    {
        ...
        private unsafe WPFBase.RelayParameterizedCommand Auto()
        {
            return new WPFBase.RelayParameterizedCommand(obj =>
            {
                ...
                MatchSetting.MainLengths.AddRange(matchSetting.MainLengths);
                MatchSetting.MainLengths.AddRange(matchSetting.SecondaryLengths);
        ...
        public ObservableCollection<double> MatchSetting { get; set; }
        ///// <summary>
        ///// 過濾斷面規格選擇器
        ///// </summary>
