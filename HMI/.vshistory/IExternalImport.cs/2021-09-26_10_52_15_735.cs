...
namespace HMI
{
    ...
    public interface IExternalImport
    {
        ...
        void CreateFile([WsdlParamOrReturnDocumentation("要儲存的路徑")] string path, [WsdlParamOrReturnDocumentation("專案名稱")] string projectName, [WsdlParamOrReturnDocumentation("發送的 byte[] 長度")] int length);
        /// <summary>
        /// 寫入資料流
        /// </summary>
