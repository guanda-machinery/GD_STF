...
#pragma warning disable CS1591 // 遺漏公用可見類型或成員 'IExternalImport' 的 XML 註解
    public interface IExternalImport
#pragma warning restore CS1591 // 遺漏公用可見類型或成員 'IExternalImport' 的 XML 註解
    {
        /// <summary>
        /// 取得根目錄
        /// </summary>
        ...
        void CreateDirectory([WsdlParamOrReturnDocumentation("要建立的資料夾")] string path);
    }
    /// <summary>
    /// 匯入檔案雙向通道
    /// </summary>
    public interface IImportDuplexCallback
    {
        ...
        void CreateDirectoryResult(bool result);
        /// <summary>
        /// 遠端創建檔案結果
        /// </summary>
        /// <param name="result">創建完成 true，重複檔案 false。</param>
