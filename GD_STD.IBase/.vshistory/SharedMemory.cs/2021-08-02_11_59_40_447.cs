...
namespace GD_STD.Base
{
    ...
    public static partial class SharedMemory
    {
        ...
        /// <returns></returns>
        public static T SetValue<T, TVaule>(long position, TVaule value, long valueOffset, int count) where T : IPhoneSharedMemoryOffset, ISharedMemory, new() where TVaule : struct
        {
            T result = new T();
