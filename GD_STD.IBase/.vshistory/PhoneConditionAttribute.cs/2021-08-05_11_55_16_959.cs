...
namespace GD_STD.Base
{
    ...
    public class PhoneConditionAttribute : Attribute
    {
        ...
        /// </summary>
        /// <param name="minValue">常數小數</param>
        /// <param name="maxValue">常數大數</param>
        ...
        /// 定義 Phone 寫入欄位否有符合最大最小值
        /// </summary>
        /// <param name="minFieldValue">要參考最小值的欄位</param>
        /// <param name="maxFieldValue">要參考最大值的欄位</param>
        public PhoneConditionAttribute(FieldInfo minFieldValue, FieldInfo maxFieldValue)
        {
            this.WriteField = true;
            this.IsConditionInitial = false;
            MinValue = minValue;
