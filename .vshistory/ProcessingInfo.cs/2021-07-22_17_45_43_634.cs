...
namespace GD_STD
{
    ...
    [Serializable()]
    [DataContract]
    public class ProcessingInfo : SerializationHelper<ProcessingInfo>, ISharedMemory
    {
        /// <summary>
        /// 預設
        /// </summary>
        ...
        void ISharedMemory.ReadMemory()
        {
            ...
            {
                this.JobInfo = SharedMemory<JobInfo>.GetValue();
        ...
        void ISharedMemory.WriteMemory()
        {
            ...
            {
                SharedMemory<JobInfo>.SetValue(this.JobInfo);
