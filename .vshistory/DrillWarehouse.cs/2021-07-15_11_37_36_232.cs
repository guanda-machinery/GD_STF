...
namespace GD_STD
{
    ...
    [Serializable()]
    [DataContract]
    public class DrillWarehouse : SerializationHelper<DrillWarehouse>, ISharedMemory, IDrillWarehouse
    {
        /// <summary>
        /// 初始化刀庫
        /// </summary>
        ...
        /// <returns></returns>
        public static DrillWarehouse Initialization(Host host)
        {
            DrillSetting[] Middle;
