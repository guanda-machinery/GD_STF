...
namespace STD_105
{
    ...
    public partial class App : Application
    {
        ...
        {
#pragma warning disable CS0618 // 'Dns.GetHostByName(string)' 已經過時: 'GetHostByName is obsoleted for this type, please use GetHostEntry instead. http://go.microsoft.com/fwlink/?linkid=14202'
            IPHostEntry iphostentry = Dns.GetHostByName(Dns.GetHostName());  //取得本機的 IpHostEntry 類別實體
#pragma warning restore CS0618 // 'Dns.GetHostByName(string)' 已經過時: 'GetHostByName is obsoleted for this type, please use GetHostEntry instead. http://go.microsoft.com/fwlink/?linkid=14202'

#pragma warning disable CS0168 // 已宣告變數 'myRequest'，但從未使用過它
            System.Net.WebRequest myRequest;
#pragma warning restore CS0168 // 已宣告變數 'myRequest'，但從未使用過它
#pragma warning disable CS0168 // 已宣告變數 'myResponse'，但從未使用過它
            System.Net.WebResponse myResponse;
#pragma warning restore CS0168 // 已宣告變數 'myResponse'，但從未使用過它
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            {
                Current.MainWindow = new Office.OfficeBaseWindow();
            }
