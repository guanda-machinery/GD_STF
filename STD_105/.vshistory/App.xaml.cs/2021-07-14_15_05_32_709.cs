...
namespace STD_105
{
    ...
    public partial class App : Application
    {
        ...
        private void App_Startup(object sender, StartupEventArgs e)
        {
            ...
            mutex = new System.Threading.Mutex(true, System.Diagnostics.Process.GetCurrentProcess().MainModule.ModuleName, out ret);

            if (!ret)
            {
                MessageBox.Show("應用程式已執行,請先已開啟的應用程式!");
                Environment.Exit(0);
            }
        }
        ...
        {
            string url = "http://192.168.31.137:820/CodesysIIS/Memor.svc";
            try
            {
                System.Net.WebRequest myRequest = System.Net.WebRequest.Create(url);
                System.Net.WebResponse myResponse = myRequest.GetResponse();
