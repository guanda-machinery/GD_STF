...
namespace STD_105
{
    ...
    public partial class MainWindow : Window
    {
        ...
        /// 持續撈取斷電保持
        /// </summary>
        private readonly System.Windows.Threading.DispatcherTimer BAVTTimer = new System.Windows.Threading.DispatcherTimer();
        ...
        public MainWindow()
        {
            ...
            BAVTTimer.Tick += new EventHandler(Timer_Click);
        ...
        private void Button_Click_1(object sender, RoutedEventArgs e)
        {
            ...
            SelectFiles import = new SelectFiles();
            empty.Content = import;
            empty.Show();
        }
