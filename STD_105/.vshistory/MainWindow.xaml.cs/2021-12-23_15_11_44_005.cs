    ...
    public partial class MainWindow : Window
    {
        ...
        public void AdjustSpeed(Int16 i)
        {
            ...
            _.DoWork += delegate (object sender, DoWorkEventArgs e)
            {
                ...
                while (IsDown)
                {
                    ...
                    WPFSTD105.Properties.MecSetting.ArmFeedOriginToOutUpRoll.HandSpeed = panelButton.HandSpeed;
                    WPFSTD105.Properties.MecSetting.ArmFeedOriginToOutUpRoll.Save();
        ...
        private void slider_PreviewMouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            if (sender != null)
            {
                ...
                panelButton.HandSpeed = (Int16)slider.Value;
                WriteCodesysMemor.SetPanel(panelButton);
                WPFSTD105.Properties.MecSetting.ArmFeedOriginToOutUpRoll.HandSpeed = (byte)panelButton.HandSpeed;
                WPFSTD105.Properties.MecSetting.ArmFeedOriginToOutUpRoll.Save();
                //ApplicationViewModel.PanelButton = panelButton;
            }
        }
