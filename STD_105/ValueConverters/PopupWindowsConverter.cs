...
namespace STD_105
{
    public class PopupWindowsConverter : WPFBase.BaseValueConverter<PopupWindowsConverter>
    {
        public override object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            switch ((PopupWindows)value)
            {
                case PopupWindows.FirstPage:
                    ...
                    break;
                case PopupWindows.BOMSettings:
                    basePage = new BOMSettings_Office();
                    break;
                case PopupWindows.ProjectsManager:
                    basePage = new ProjectsManager_Office();
                    break;
                case PopupWindows.GraphBrowser:
                    basePage = new GraphBrowser_Office();
                    break;
                default:
                    break;
            }
