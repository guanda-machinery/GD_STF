...
namespace STD_105
{
    ...
    public partial class SettingParPage : BasePage<SettingParVM>
    {
        ...
        /*
        private void Material_PreviewMouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            ViewModel.SaveModelRoSystem = ViewModel.SaveMaterial();
            ViewModel.IOAbort();
        }

        private void Profile_PreviewMouseLeftButtonUp(object sender, MouseButtonEventArgs e)
        {
            ViewModel.SaveModelRoSystem = ViewModel.SaveProfile();
            ViewModel.IOAbort();
        }
        */
    }
