...
namespace ConsoleApp3
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            long po = SharedMemory.GetMemoryOffset<MonitorWork>(work, $"{nameof(MonitorWork.WorkMaterial)}[1].{nameof(WorkMaterial.Finish)}");
            Int16 _ = 200;
            Enum e = MATERIAL.SM490A;
            PCSharedMemory.SetValue<MonitorWork>(po, _);
            long resultPo = SharedMemory.GetMemoryOffset<MonitorWork>(work, $"{nameof(MonitorWork.WorkMaterial)}[1]");
