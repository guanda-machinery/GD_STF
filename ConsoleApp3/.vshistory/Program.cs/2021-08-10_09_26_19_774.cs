...
namespace ConsoleApp3
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            long po = SharedMemory.GetMemoryOffset<MonitorWork>(work, $"{nameof(MonitorWork.WorkMaterial)}[2999].{nameof(WorkMaterial.Material)}");
            //Enum e = ;
            PCSharedMemory.SetValue<MonitorWork>(po, (Int16)MATERIAL.SM490A);
            long workMaterialIndex = SharedMemory.GetMemoryOffset<MonitorWork>(work, $"{nameof(MonitorWork.WorkMaterial)}[2999]");
            WorkMaterial result= PCSharedMemory.GetValue<MonitorWork, WorkMaterial>(workMaterialIndex, Marshal.SizeOf(typeof(WorkMaterial)));
