...
namespace ConsoleApp3
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            WorkMaterial insert = WorkMaterial.Initialization();
            insert.Length = 200;
            OpenSharedMemory();
            PCSharedMemory.SetValue<MonitorWork>(i, insert);
            ...
            //PCSharedMemory.SetValue<MonitorWork>(i, 200d);
            WorkMaterial workMaterial = PCSharedMemory.GetValue<MonitorWork, WorkMaterial>(Marshal.SizeOf(typeof(WorkMaterial)), Marshal.SizeOf(typeof(WorkMaterial)));
