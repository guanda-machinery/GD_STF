...
namespace ConsoleApp3
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            startInfo.Arguments = $"netsh advfirewall firewall add rule name=\"檔案列印共用\" protocol=TCP dir=in localport=1111 action=block && netsh advfirewall firewall add rule name=\"檔案列印共用\" protocol=TCP dir=out localport={port} action=block";
