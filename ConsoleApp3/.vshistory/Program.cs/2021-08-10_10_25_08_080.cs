...
namespace ConsoleApp3
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            long resultPo = SharedMemory.GetMemoryOffset<MonitorWork>(work, $"{nameof(MonitorWork.WorkMaterial)}[0].{nameof(WorkMaterial.Length)}");
            double result = PCSharedMemory.GetValue<MonitorWork, double>(resultPo, Marshal.SizeOf(typeof(double)));
