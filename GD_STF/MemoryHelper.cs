...
#pragma warning disable CS1574 // XML 註解有無法解析的 cref 屬性 'DrMiddle'
        /// <summary>
...
#pragma warning restore CS1574 // XML 註解有無法解析的 cref 屬性 'DrMiddle'

#pragma warning disable CS1574 // XML 註解有無法解析的 cref 屬性 'DrRight'
        /// <summary>
...
#pragma warning restore CS1574 // XML 註解有無法解析的 cref 屬性 'DrRight'
...
#pragma warning disable CS1574 // XML 註解有無法解析的 cref 屬性 'JobInfo'
#pragma warning disable CS1574 // XML 註解有無法解析的 cref 屬性 'JobInfo'
        /// <summary>
...
#pragma warning restore CS1574 // XML 註解有無法解析的 cref 屬性 'JobInfo'
#pragma warning restore CS1574 // XML 註解有無法解析的 cref 屬性 'JobInfo'
        /// <summary>
        ...
        /// 素材接觸
        /// </summary>
        public static MemoryMappedFile MaterialTouchTMemory { get; set; }
        ///// <summary>
        ///// 如果 <see cref="ERROR_CODE.Unknown"/> 就來這邊看錯誤代碼
        ///// </summary>
        //public static MemoryMappedFile GameMemory { get; set; }
#pragma warning disable CS1591 // 遺漏公用可見類型或成員 'MemoryHelper.AndroidTestMemory' 的 XML 註解
        public static MemoryMappedFile AndroidTestMemory { get; set; }
#pragma warning restore CS1591 // 遺漏公用可見類型或成員 'MemoryHelper.AndroidTestMemory' 的 XML 註解
        /// <summary>
        /// 共享 <see cref="GD_STD.MainAxisLocation"/> 
        /// </summary>
        public static MemoryMappedFile MainAxisLocationMemory { get; set; }
        #endregion
        ...
        public static void OpenSharedMemory()
        {
            ...
            //GameMemory = MemoryMappedFile.CreateOrOpen("ywww888", Marshal.SizeOf(typeof(Game)));
            AndroidTestMemory = MemoryMappedFile.CreateOrOpen("jkluv99", Marshal.SizeOf(typeof(AndroidTest)));
            MainAxisLocationMemory = MemoryMappedFile.CreateOrOpen("MainAxisLocation", Marshal.SizeOf(typeof(MainAxisLocation)));

            MaterialTouchTMemory =  MemoryMappedFile.CreateOrOpen("Material_Touch", Marshal.SizeOf(typeof(byte)));
        }
        ...
        /// 鑽頭斷電前是否接觸工件
        /// </summary>
        /// <returns>接觸回傳 true，沒有接觸則回傳 false。</returns>
        public static bool GetMaterialTouch()
        {
            int size = Marshal.SizeOf(typeof(byte));
            using (var memory = MaterialTouchTMemory.CreateViewAccessor(0, size, MemoryMappedFileAccess.Read))
            {
                byte value;
