...
namespace GD_STD
{
    ...
    public static class MemoryHelper
    {
        ...
        public static void OpenSharedMemory()
        {
            ...
            /*加工資訊*/
            JobInfoMemory = MemoryMappedFile.CreateOrOpen("JobInfo", Marshal.SizeOf(typeof(JobInfo)));
        ...
        {
            Host host = Base.SharedMemory.GetValue<Host>();
            host.PCOpen = false;
            SharedMemory.SetValue<Host>(host); //寫入記憶體通知 Codesys 主機， PC 已關閉
