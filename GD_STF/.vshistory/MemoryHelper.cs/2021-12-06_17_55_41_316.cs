...
namespace GD_STD
{
    ...
    public static class MemoryHelper
    {
        ...
        /// </summary>
        public static MemoryMappedFile MainAxisLocation { get; set; }
        #endregion
        ...
        public static void OpenSharedMemory()
        {
            ...
            //小霖:
            MainAxisLocation = MemoryMappedFile.CreateOrOpen("MainAxisLocation", Marshal.SizeOf(typeof(MainAxisLocation)));
        }
