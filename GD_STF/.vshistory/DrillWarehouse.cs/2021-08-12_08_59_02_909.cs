...
namespace GD_STD
{
    ...
    public class DrillWarehouse : SerializationHelper<DrillWarehouse>, IPCSharedMemory, IDrillWarehouse
    {
        ...
        /// 初始化刀庫
        /// </summary>
        /// <param name="mecSetting"></param>
        /// <returns></returns>
        public static DrillWarehouse Initialization(MechanicalSetting mecSetting)
        {
            DrillSetting[] Middle;
        ...
        private DrillWarehouse(DrillSetting[] leftEntrance, DrillSetting[] leftExport, DrillSetting[] middle, DrillSetting[] rightEntrance, DrillSetting[] rightExport)
        {
            LeftEntrance = leftEntrance;
            LeftExport = leftExport;
            Middle = middle;
            RightEntrance = rightEntrance;
            RightExport = rightExport;
        }

        /// <summary>
        /// 預設建構式
        /// </summary>
        public DrillWarehouse()
        {
            //Host host = SharedMemory<Host>.GetValue();

            //DrillWarehouse _ = Initialization(null);

            //Middle = _.Middle;
            //LeftExport = _.LeftExport;
            //RightExport = _.RightExport;
            //LeftEntrance = _.LeftEntrance;
            //RightEntrance = _.RightEntrance;
        }
