...
namespace 測試GD_STD_Phone專案
{
    public class TestObjectInfo
    {
        ...
        /// <param name="secondFieldValue"></param>
        public TestObjectInfo(string mainFieldName, object mainFieldValue, string secondFieldName, object secondFieldValue)
        {
            this.writeFieldName = mainFieldName;
            this.writefieldValue = mainFieldValue;
