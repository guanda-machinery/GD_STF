...
namespace ConsoleApp7
{
    class Program
    {
        ...
        private unsafe static extern void* CreateFile(string fileName, long dwDesiredAccess,
        ...
        {
            void* vLmsensor = CreateFile("\\\\.\\AdvLmDev", 0x40000000L, 0x00000002, IntPtr.Zero, 3, 0, IntPtr.Zero);
