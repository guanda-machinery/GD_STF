...
namespace ConsoleApp7
{
    class Program
    {
        ...
        private static extern bool DeviceIoControl(IntPtr device, uint ctlcode, ref ulong[] inbuffer, int szie,IntPtr outbuffer, int outbufferSize, IntPtr bytesreturned, IntPtr overlapped);
        ...
        static void Main(string[] args)
        {
            ...
            int bytesReturned = 0;
            intPtr = CreateFile("\\\\.\\AdvLmDev", FileAccess.Write,
            ...
            while (true)
            {
                ulong[] voltage = new ulong[5];
                bool ok = DeviceIoControl(intPtr, IOCTL_LMSENSOR_GET_TEMP, ref voltage, Marshal.SizeOf(typeof(ulong)), IntPtr.Zero,0, IntPtr.Zero, IntPtr.Zero);
