...
REM Help Viewer 1.0
HelpLibraryManagerLauncher.exe /product "VS" /version "100" /locale zh-chs /uninstall /silent /vendor "Vendor Name" /productName "STDMemoryLibrary" /mediaBookList "STDMemoryLibrary"
...
REM Help Viewer 2.x
HelpLibraryManagerLauncher.exe /viewerVersion %1  /locale zh-chs /wait 0 /operation uninstall /vendor "Vendor Name" /productName "STDMemoryLibrary" /bookList "STDMemoryLibrary"
